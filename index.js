...
// the rest
app.use(express.static(path.join(__dirname, '../../sysshrty.github.io/final-project/public')));
//server
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, '../../final-project')); //'../../final-project/public', 'index.html'
});
